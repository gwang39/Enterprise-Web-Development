...
/**
 * This program provides quote to server based on user inputs from the server
 * @author Guan Yue Wang
 */
@WebServlet(name = "wang_sr2", urlPatterns = {"/wang_sr2"})
public class wang_sr2 extends HttpServlet {
